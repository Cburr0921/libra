...
export default function BookDetailsPage({ user }) {
  ...
  const [wishlistStatus, setWishlistStatus] = useState({ loading: false, error: null, added: false });
  ...
  const handleAddToWishlist = async () => {
    ...
    try {
      setWishlistStatus({ loading: true, error: null, added: false });
                  ...
                  {user ? (
                    <>
                      ...
                      {wishlistStatus.error && (
                        <p className="w-full text-red-600">{wishlistStatus.error}</p>
                      )}
                    </>
                  ) : (
                    <Link
